...
public final class ResonanceMixingCategory extends CreateRecipeCategory<ResonanceMixingRecipe> {

    private final AnimatedMixer mixer = new AnimatedMixer();

    public ResonanceMixingCategory(Info<ResonanceMixingRecipe> info) {
        super(info);
    }

    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, ResonanceMixingRecipe recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.RENDER_ONLY, 134, 81)
                .addItemStack(new ItemStack(Blocks.AMETHYST_BLOCK));
    }

    @Override
    public void draw(ResonanceMixingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics graphics,
        ...
        AnimatedKinetics.defaultBlockElement(Blocks.AMETHYST_BLOCK.defaultBlockState())
                .atLocal(0, 1.65, 0)
                .scale(23)
                .render(graphics);
